---
title: "Statistical Inference Project part1 Simulation Excercise"
author: "Pinku Barman"
date: "April 20, 2019"
output: 
  html_document:
...
```r
#Plot sample means distribution with the calculated...
sim_mns  %>%
...
![](Project_Part1_Simulation_Excercise_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
...
![](Project_Part1_Simulation_Excercise_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
